...
hook OnGameModeInit()
{
	...
	new npcDid = FAI_GetBossNPCID(BossBigSmoke);
	SetPlayerColor(npcDid, 0xffffff00);
	FCNPC_Spawn(npcDid, 0, 1086.9752, 1074.7021, -50.0);
	FCNPC_SetInterior(npcDid, INTERIOR_NORMAL);
	FCNPC_SetVirtualWorld(npcDid, VIRTUAL_WORLD_NORMAL);
